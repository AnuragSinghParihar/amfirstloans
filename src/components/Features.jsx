...
const features = [
  ...
  },
  {
    ...
    desc: "AM First Loan interest is much lower than personal or business loans"
  },
  {
  ...
  },
  {
    ...
    desc: "Follow our 5 easy steps to getting your pre-approved AM First Loan!"
  },
  {
    ...
    <>
        <section id="Features">
            <div className="carloan-features-wrapper">
                <h2 className="carloan-title">Why Choose AM First Loans?</h2>
